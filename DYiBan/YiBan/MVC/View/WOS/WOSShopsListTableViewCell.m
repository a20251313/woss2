...
//    }
    ...
    UILabel *imageViewIndexchuan = [[UILabel  alloc]initWithFrame:CGRectMake(CGRectGetMinX(labelName.frame), 20 + 10, imageType.size.width/2, imageType.size.height/2)];
//    [imageViewIndexchuan setImage:imageType];
    
    
    
    
    [imageViewIndexchuan setTextAlignment:NSTextAlignmentCenter];
    [imageViewIndexchuan setTextColor:[UIColor whiteColor]];
    [imageViewIndexchuan.layer setCornerRadius:2];
    [imageViewIndexchuan.layer setBorderWidth:0.0f];
    [imageViewIndexchuan.layer setMasksToBounds:YES];
    
    [imageViewIndexchuan setText:[[dict objectForKey:@"typeName"] substringToIndex:1]];
    [imageViewIndexchuan setFont:[UIFont systemFontOfSize:10]];
//    [imageViewIndexchuan setBackgroundColor:[UIColor redColor]];
    [imageViewIndexchuan setBackgroundColor:[UIColor colorWithRed:255.0f/255 green:91.0f/255 blue:91.0f/255 alpha:1.0f]];
